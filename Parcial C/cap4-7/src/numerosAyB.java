 ...
 * @author Homar
 */
public class numerosAyB extends javax.swing.JFrame {

    /**
     * Creates new form numerosAyB
     */
    public numerosAyB() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ingresar numeros para comparar");
...
double NumA, NumB;
try {
NumA = Double.parseDouble(numA.getText());
        NumB = Double.parseDouble(numB.getText());
        
        if ( NumA > NumB) {
            JOptionPane.showMessageDialog(null, "el numero " +NumA +" es mayor a el número " +NumB);
        }
        if (NumB > NumA) {
            JOptionPane.showMessageDialog(null, "el numero " +NumB +" es mayor a el número " +NumA);
        }
        if (NumA == NumB) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(numerosAyB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new numerosAyB().setVisible(true);
            }
        });
    }
